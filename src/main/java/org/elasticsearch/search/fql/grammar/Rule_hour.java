...
final public class Rule_hour extends Rule
{
  public Rule_hour(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_hour parse(ParserContext context)
  {
    context.push("hour");
    ...
    if (parsed)
    {
        rule = new Rule_hour(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

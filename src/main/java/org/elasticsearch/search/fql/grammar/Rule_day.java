...
final public class Rule_day extends Rule
{
  public Rule_day(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_day parse(ParserContext context)
  {
    context.push("day");
    ...
    if (parsed)
    {
        rule = new Rule_day(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

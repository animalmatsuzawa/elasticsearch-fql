...
public class XContentBuilderTests extends ESTestCase {
    public void testPrettyWithLfAtEnd() throws Exception {
        ...
        XContentGenerator generator = XmlXContentFactory.xContent(XmlXContentType.JSON).createGenerator(os);
    ...
    public void testRaw() throws IOException {
        {
            XContentBuilder xContentBuilder = XmlXContentFactory.contentBuilder(XmlXContentType.JSON);
        ...
        }
        {
            ...
            xContentBuilder.endObject();
            assertThat(xContentBuilder.bytes().utf8ToString(), 
    ...
    public void testSimpleGenerator() throws Exception {
        XContentBuilder builder = XmlXContentFactory.contentBuilder(XmlXContentType.JSON);
        builder.startObject().field("test", "value").endObject();
        assertThat(builder.string(), equalTo("{\"test\":\"value\"}"));

        builder = XmlXContentFactory.contentBuilder(XContentType.JSON);
        builder.startObject().field("test", "value").endObject();
        assertThat(builder.string(), equalTo("{\"test\":\"value\"}"));
    }
    ...
    public void testWritingBinaryToStream() throws Exception {
        ...
        XContentGenerator gen = XmlXContentFactory.xContent(XmlXContentType.JSON).createGenerator(bos);
    ...
    public void testDateTypesConversion() throws Exception {
        ...
        builder = XmlXContentFactory.contentBuilder(XmlXContentType.JSON);
    ...
    private void checkPathSerialization(Path path) throws IOException {
        XContentBuilder pathBuilder = XmlXContentFactory.contentBuilder(XmlXContentType.JSON);
        pathBuilder.startObject().field("file", path).endObject();

        XContentBuilder stringBuilder = XmlXContentFactory.contentBuilder(XmlXContentType.JSON);
    ...
    public void testRenderGeoPoint() throws IOException {
        XContentBuilder builder = XmlXContentFactory.contentBuilder(XmlXContentType.JSON).prettyPrint();
    ...
    public void testWriteMapWithNullKeys() throws IOException {
        XContentBuilder builder = XmlXContentFactory.contentBuilder(randomFrom(XContentType.values()));
        try {
    ...
    public void testMissingEndObject() throws IOException {
        IllegalStateException e = expectThrows(IllegalStateException.class, () -> {
            try (XContentBuilder builder = XmlXContentFactory.contentBuilder(randomFrom(XContentType.values()))) {
                builder.startObject();
